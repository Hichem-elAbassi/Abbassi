...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.cv' => 'getSonata_Admin_CvService',
            ...
            'sonata.admin.groupes' => 'getSonata_Admin_GroupesService',
            ...
            'sonata.admin.projets' => 'getSonata_Admin_ProjetsService',
            ...
            'sonata.admin.transactions' => 'getSonata_Admin_TransactionsService',
            ...
            'sonata.admin.utilisateurs' => 'getSonata_Admin_UtilisateursService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'freelancer', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Blitz\\BackOfficeBundle\\Entity'))), 'Blitz\\BackOfficeBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('BlitzBackOfficeBundle' => 'Blitz\\BackOfficeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d3aca22be81c1a42c74776a40c1f1bd111239669d0a4659c385859735f967319');
    ...
    /**
     * Gets the 'sonata.admin.cv' service.
     *
     * @return \Blitz\BackOfficeBundle\Admin\CvAdmin A Blitz\BackOfficeBundle\Admin\CvAdmin instance.
     */
    protected function getSonata_Admin_CvService()
    {
        $instance = new \Blitz\BackOfficeBundle\Admin\CvAdmin('sonata.admin.cv', 'Blitz\\BackOfficeBundle\\Entity\\Cv', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('BackOfficeBundle');
    ...
    /**
     * Gets the 'sonata.admin.groupes' service.
     *
     * @return \Blitz\BackOfficeBundle\Admin\GroupesAdmin A Blitz\BackOfficeBundle\Admin\GroupesAdmin instance.
     */
    protected function getSonata_Admin_GroupesService()
    {
        $instance = new \Blitz\BackOfficeBundle\Admin\GroupesAdmin('sonata.admin.groupes', 'Blitz\\BackOfficeBundle\\Entity\\Groupes', 'SonataAdminBundle:CRUD');
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'TunisianFreelancer BackOffice', 'bundles/sonataadmin/logo_title.png', array('html5_validate' => true, 'confirm_exit' => true, 'use_select2' => true, 'use_icheck' => true, 'pager_links' => NULL, 'form_type' => 'standard', 'dropdown_number_groups_per_colums' => 2, 'title_mode' => 'both', 'javascripts' => array(0 => 'bundles/sonatacore/vendor/jquery/dist/jquery.min.js', 1 => 'bundles/sonataadmin/vendor/jquery.scrollTo/jquery.scrollTo.min.js', 2 => 'bundles/sonatacore/vendor/moment/min/moment.min.js', 3 => 'bundles/sonatacore/vendor/bootstrap/dist/js/bootstrap.min.js', 4 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js', 5 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/jquery-ui.min.js', 6 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/i18n/jquery-ui-i18n.min.js', 7 => 'bundles/sonataadmin/jquery/jquery.form.js', 8 => 'bundles/sonataadmin/jquery/jquery.confirmExit.js', 9 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js', 10 => 'bundles/sonatacore/vendor/select2/select2.min.js', 11 => 'bundles/sonataadmin/vendor/admin-lte/dist/js/app.min.js', 12 => 'bundles/sonataadmin/vendor/iCheck/icheck.min.js', 13 => 'bundles/sonataadmin/vendor/slimScroll/jquery.slimscroll.min.js', 14 => 'bundles/sonataadmin/Admin.js', 15 => 'bundles/sonataadmin/treeview.js'), 'stylesheets' => array(0 => 'bundles/sonatacore/vendor/bootstrap/dist/css/bootstrap.min.css', 1 => 'bundles/sonatacore/vendor/components-font-awesome/css/font-awesome.min.css', 2 => 'bundles/sonatacore/vendor/ionicons/css/ionicons.min.css', 3 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/AdminLTE.min.css', 4 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/skins/skin-black.min.css', 5 => 'bundles/sonataadmin/vendor/iCheck/skins/flat/blue.css', 6 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css', 7 => 'bundles/sonataadmin/vendor/jqueryui/themes/base/jquery-ui.css', 8 => 'bundles/sonatacore/vendor/select2/select2.css', 9 => 'bundles/sonatacore/vendor/select2-bootstrap-css/select2-bootstrap.min.css', 10 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css', 11 => 'bundles/sonataadmin/css/styles.css', 12 => 'bundles/sonataadmin/css/layout.css', 13 => 'bundles/sonataadmin/css/tree.css')), array());
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.transactions', 1 => 'sonata.admin.projets', 2 => 'sonata.admin.utilisateurs', 3 => 'sonata.admin.groupes', 4 => 'sonata.admin.cv'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.admin.transactions', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.admin.projets', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.admin.utilisateurs', 'label' => '', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'sonata.admin.groupes', 'label' => '', 'route' => '', 'route_params' => array()), 4 => array('admin' => 'sonata.admin.cv', 'label' => '', 'route' => '', 'route_params' => array())))));
        $instance->setAdminClasses(array('Blitz\\BackOfficeBundle\\Entity\\Transactions' => array(0 => 'sonata.admin.transactions'), 'Blitz\\BackOfficeBundle\\Entity\\Projets' => array(0 => 'sonata.admin.projets'), 'Blitz\\BackOfficeBundle\\Entity\\Utilisateurs' => array(0 => 'sonata.admin.utilisateurs'), 'Blitz\\BackOfficeBundle\\Entity\\Groupes' => array(0 => 'sonata.admin.groupes'), 'Blitz\\BackOfficeBundle\\Entity\\Cv' => array(0 => 'sonata.admin.cv')));

        return $instance;
    }

    /**
     * Gets the 'sonata.admin.projets' service.
     *
     * @return \Blitz\BackOfficeBundle\Admin\ProjetsAdmin A Blitz\BackOfficeBundle\Admin\ProjetsAdmin instance.
     */
    protected function getSonata_Admin_ProjetsService()
    {
        $instance = new \Blitz\BackOfficeBundle\Admin\ProjetsAdmin('sonata.admin.projets', 'Blitz\\BackOfficeBundle\\Entity\\Projets', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.transactions', 1 => 'sonata.admin.projets', 2 => 'sonata.admin.utilisateurs', 3 => 'sonata.admin.groupes', 4 => 'sonata.admin.cv'), $this);
    }
    ...
    /**
     * Gets the 'sonata.admin.transactions' service.
     *
     * @return \Blitz\BackOfficeBundle\Admin\TransactionsAdmin A Blitz\BackOfficeBundle\Admin\TransactionsAdmin instance.
     */
    protected function getSonata_Admin_TransactionsService()
    {
        $instance = new \Blitz\BackOfficeBundle\Admin\TransactionsAdmin('sonata.admin.transactions', 'Blitz\\BackOfficeBundle\\Entity\\Transactions', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.admin.twig.extension'] = new \Sonata\AdminBundle\Twig\Extension\SonataAdminExtension($this->get('sonata.admin.pool'), $this->get('router'), $this->get('logger', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'sonata.admin.utilisateurs' service.
     *
     * @return \Blitz\BackOfficeBundle\Admin\UtilisateursAdmin A Blitz\BackOfficeBundle\Admin\UtilisateursAdmin instance.
     */
    protected function getSonata_Admin_UtilisateursService()
    {
        $instance = new \Blitz\BackOfficeBundle\Admin\UtilisateursAdmin('sonata.admin.utilisateurs', 'Blitz\\BackOfficeBundle\\Entity\\Utilisateurs', 'SonataAdminBundle:CRUD');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Blitz\\BackOfficeBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Blitz\\BackOfficeBundle/Resources/views'), 'BlitzBackOffice');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BlitzBackOfficeBundle' => 'Blitz\\BackOfficeBundle\\BlitzBackOfficeBundle',
